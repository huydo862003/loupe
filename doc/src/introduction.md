...
It leverages well-known program analysis techniques, algorithms, and heuristics to answer very common questions about codebases. Loupe itself doesn't use AI, because I want a reliable, fast and simple tool. That said, AI agents are one of the intended consumers of this tool, and it's designed to work well with them.
