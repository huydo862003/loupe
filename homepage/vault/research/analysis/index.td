...
This is the foundation everything else in Loupe builds on. Without a solid model of what the code actually is, querying, refactoring, and QA are not plausible.
